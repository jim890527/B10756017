...
class UI:
    ...
    def tools():
        ...
        root.iconbitmap("py.ico")   # ico
        root.title('戴姿穎我愛妳')
        root.geometry('300x570')    # x,y
        en = tk.Entry(root,width=8)   # entry
        en.place(x=240,y=0)
        tk.Label(root,text="操作介面",bg='#1ABC9C',font=('Arial',20) ,width=300,height=3,fg='#FFFFFF').pack(side="top")
        tk.Button(root, text='影像辨識',command=lambda:video(str(en.get())),bg='#1ABC9C',width=40,height=3,font=('Arial',12),fg='#FFFFFF').pack(side="top",fill='x')
        ...
        tk.Button(root, text='清除所有雷達圖資料',command=lambda:DB.drop_player_radar('1'),bg='#1ABC9C',width=40,height=3,font=('Arial',12),fg='#FFFFFF').pack(side="top",fill='x')
    ...
    def login_window():
        ...
        tkWindow.iconbitmap("py.ico")   # ico
